...
type SgeDePara struct {
	EmpCod              sql.NullInt32
	Cod                 sql.NullInt32
	NomeRh              sql.NullString
	EstruturaIDSge      sql.NullInt32
	ColecaoIDSge        sql.NullInt32
	RegistroEstruturaID sql.NullInt32
	NomeSge             sql.NullString
	CodHierarquia       sql.NullString
	CodConsist          sql.NullString
	EstruturaUems       sql.NullInt32
}
